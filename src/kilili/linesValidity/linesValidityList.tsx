...
import style from '../../lineStatistics/components/linesValidity/linesValidity.module.scss';
import { useRandomId } from "@entur/utils";
import { Heading3 } from "@entur/typography";
import { BannerAlertBox } from "@entur/alert";
import { LineStatistics, PeriodValidity, Validity } from '../../lineStatistics/lineStatistics.types';
import { useLocale } from '../../appContext';
import { sortLines } from '../../lineStatistics/components/linesValidity/linesFilters/sortingUtilities';
import { Timeline } from '../../lineStatistics/components/timeline/timeline';
import { ValidityChips } from '../../lineStatistics/components/linesValidity/linesFilters/validityChips';
import { infoText, validityCategoryLabel } from '../../lineStatistics/lineStatistics.constants';
import { SortingChips } from '../../lineStatistics/components/linesValidity/linesFilters/sortingChips';
import { ExpandableTimeline } from '../../lineStatistics/components/expandableTimeline/expandableTimeline';
import { ValidNumberOfDaysText } from '../../lineStatistics/components/linesValidity/validNumberOfDaysText';
import { LinesValidityHeader } from '../../lineStatistics/components/linesValidity/linesValidityHeader';
import { useLineStatisticsPublicLineDetails } from './useLineStatisticsPublicLineDetails';
